...
export const SearchResultItem = memo(function SearchResultItem({
  ...
  const timeAgo = useMemo(() => formatRelativeTime(result.date), [result.date]);
  ...
  return (
    ...
    >
      ...
      <p
        className="text-sm text-muted-foreground line-clamp-2 w-full text-left [&>mark]:bg-neutral-200 [&>mark]:dark:bg-neutral-800 [&>mark]:px-0.5 [&>mark]:rounded-sm"
        dangerouslySetInnerHTML={{
          __html: result.snippet || result.text || '[No content]',
        }}
      />
